...
<body class="page-login">
	...
	<section id="login" class="form__login">
		...
		<form id="formLogin" action="logar.php" method="post" novalidate>
			...
			<div>
				<small> <a class="link" href="forgot-password.php"> forgot you password? </a> </small>
			</div>

			<div class="text-center">
				<input type="submit" class="btn-submit" value="kill me">
				<a href="singup.php" class="btn-submit btn-singup"> Sing Up </a>
			</div>
